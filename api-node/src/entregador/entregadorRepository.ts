...
export const listarProximos = (latitude: number, longitude: number, raioKm: number): Promise<Entregador[]> => {
  return new Promise((resolve, reject) => {
...
export const buscarEntregadorPorId = (id: number | string): Promise<Entregador | null> => {
  return new Promise((resolve, reject) => {
...
export const editarEntregadorPorId = (id: number | string, entregador: Partial<Entregador>): Promise<Entregador> => {
  return new Promise((resolve, reject) => {
...
export const deletarEntregador = (id: number | string): Promise<boolean> => {
  return new Promise((resolve, reject) => {
...
export const listarEntregadores = (): Promise<Entregador[]> => {
  return new Promise((resolve, reject) => {
...
export const atualizarStatus = (id: number | string, novoStatus: string): Promise<Entregador> => {
...
export const atualizarLocalizacao = (id: number | string, latitude: number, longitude: number): Promise<boolean> => {
  return new Promise((resolve, reject) => {
