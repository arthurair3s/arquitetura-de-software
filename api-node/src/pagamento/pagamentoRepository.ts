...
export const buscarPagamentoPorId = async (id: number | string): Promise<Pagamento | null> => {
...
export const criarPagamento = async (pagamento: Pagamento): Promise<Pagamento> => {
...
export const editarPagamentoPorId = async (id: number | string, pagamento: Partial<Pagamento>): Promise<Pagamento> => {
...
export const deletarPagamento = async (id: number | string): Promise<boolean> => {
